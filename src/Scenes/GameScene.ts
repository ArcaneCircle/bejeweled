...
import backgroundBoard from '/background_board.png'
import Border from '/Border.png'
import selectedTile from '/selectedTile.png'
import ScoreBoard from '/ScoreBoard.png'
import ScoreBorder from '/ScoreBorder.png'
import LevelBarBackground from '/levelBarBackground.png'
import LevelBar from '/levelbar.jpg'
import ButtonReset from '/buttonReset.png'
import ButtonMenu from '/buttonMenu.png'
import RestartButton from '/restartBtn.png'
import ScoreMenu from '/scoreMenu.jpg'
import bubble1 from '/bubble_single_1.mp3'
import bubble2 from '/bubble_single_2.mp3'
import bubble3 from '/bubble_single_3.mp3'
