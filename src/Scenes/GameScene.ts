...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    levelBarImg = this.add
      .image(INITIAL_BOARD_SCREEN.WIDTH + 120, 1260 + 100, "LevelBar")
      .setDepth(1)
      .setOrigin(0, 0);
    this.add
      .image(
        this.cameras.main.centerX,
        INITIAL_BOARD_SCREEN.HEIGHT - 70,
        "backgroundBoard",
      )
      .setDepth(1)
      .setOrigin(0.5, 0)
    ...
    this.add
      .image(
        this.cameras.main.centerX,
        INITIAL_BOARD_SCREEN.HEIGHT - 90,
        "Border",
      )
      .setDepth(1)
      .setOrigin(0.5, 0);
    ...
    buttonResetRectangle = this.add
      .rectangle(this.cameras.main.centerX, 1370 + 140, 600, 120, 14101760, 0.8)
      .setDepth(1)
      .setOrigin(0.5, 0);
    buttonResetRectangle.setInteractive({ useHandCursor: true });
    buttonResetRectangle.on("pointerup", () =>
      !gameManager.isMoving ? gameManager.reset() : null,
    );

    buttonResetText = this.add
      .text(this.cameras.main.centerX, 1370 + 160, "RESTART", {
        font: newLocal,
      })
      .setDepth(1)
      .setOrigin(0.5, 0);

    buttonMenuRectangle = this.add
      .rectangle(this.cameras.main.centerX, 1370 + 300, 600, 120, 14101760, 0.8)
      .setDepth(1)
      .setOrigin(0.5, 0);
    buttonMenuRectangle.setInteractive({ useHandCursor: true });
    buttonMenuRectangle.on("pointerup", () => this.scene.start("MenuScene"));

    buttonMenuText = this.add
      .text(this.cameras.main.centerX, 1370 + 320, "HIGHSCORES", {
        font: newLocal,
      })
      .setDepth(1)
      .setOrigin(0.5, 0);
