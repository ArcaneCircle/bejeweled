...
export default class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .image(this.cameras.main.centerX, 150, "logo")
      .setDepth(1)
      .setOrigin(0.5, 0)
      .setScale(6);
    ...
    this.add
      .text(100, 700, posArr, { font: "bold 70px monospace", align: "left" })
      .setDepth(1)
      .setOrigin(0, 0);
    this.add
      .text(this.cameras.main.centerX, 700, nameArr, {
    ...
    const text = this.add
      .text(
        ...
        "click to play",
        { font: "bold 53px monospace", color: "#ec5713" },
      )
      .setDepth(1)
      .setOrigin(0.5);
